...
{
  pf_->updateResample();
  bool isconverged = pf_->isConverged();
  ROS_INFO_STREAM("converged: " << isconverged << ", localization active: " << global_localization_active_);
  if (/*pf_->isConverged()*/isconverged && global_localization_active_)
  {
