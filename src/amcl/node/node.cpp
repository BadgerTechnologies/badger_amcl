    ...
    tf_listener_(tf_buffer_)
{
  ...
  private_nh_.param("global_localizaton_convergence_threshold", convergence_threshold, 95.00);
...
void Node::reconfigureCB(AMCLConfig& config, uint32_t level)
{
  ...
  pf_ = std::make_shared<ParticleFilter>(min_particles_, max_particles_, alpha_slow_, alpha_fast_, convergence_threshold,
